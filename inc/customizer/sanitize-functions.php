<?php
/**
 * Test Theme Options Sanitization Functions
 *
 * @package Test
 */
 ...
 */
function test_sanitize_select( $input, $setting ) {
 ...
 */
function test_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function test_sanitize_post( $input ) {
 ...
 */
function test_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since 1.0
 */
function test_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if ( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function test_sanitize_number_range( $number, $setting ) {
 ...
 * @return string
 */
function test_sanitize_date_time( $input ) {
